...
import { AnalysisOptions as AnalysisOptionsType } from '@shared/types';
...
export function AnalysisOptionsComponent({ options, onChange }: AnalysisOptionsProps) {
  const handleOptionChange = (option: keyof AnalysisOptionsType, value: boolean) => {
    onChange({
      ...options,
      [option]: value,
    });
